...
# 默认插件市场列表
DEFAULT_MARKET="https://github.com/jxxghp/MoviePilot-Plugins/,https://github.com/thsrite/MoviePilot-Plugins/,https://github.com/honue/MoviePilot-Plugins/,https://github.com/InfinityPacer/MoviePilot-Plugins/,https://github.com/dandkong/MoviePilot-Plugins/,https://github.com/Aqr-K/MoviePilot-Plugins/,https://github.com/AnjoyLi/MoviePilot-Plugins/,https://github.com/WithdewHua/MoviePilot-Plugins/,https://github.com/HankunYu/MoviePilot-Plugins/,https://github.com/baozaodetudou/MoviePilot-Plugins/,https://github.com/almus2zhang/MoviePilot-Plugins/,https://github.com/Pixel-LH/MoviePilot-Plugins/,https://github.com/lightolly/MoviePilot-Plugins/,https://github.com/suraxiuxiu/MoviePilot-Plugins/,https://github.com/gxterry/MoviePilot-Plugins/,https://github.com/hotlcc/MoviePilot-Plugins-Third/,https://github.com/boeto/MoviePilot-Plugins/,https://github.com/xiangt920/MoviePilot-Plugins/,https://github.com/yubanmeiqin9048/MoviePilot-Plugins/,https://github.com/loongcheung/MoviePilot-Plugins/,https://github.com/xcehnz/MoviePilot-Plugins/,https://github.com/imaliang/MoviePilot-Plugins/,https://github.com/wikrin/MoviePilot-Plugins/,https://github.com/KoWming/MoviePilot-Plugins,https://github.com/madrays/MoviePilot-Plugins,https://github.com/aClarkChen/MoviePilot-Plugins,https://github.com/justzerock/MoviePilot-Plugins,https://github.com/Seed680/MoviePilot-Plugins,https://github.com/DzAvril/MoviePilot-Plugins,https://github.com/xijin285/MoviePilot-Plugins,https://github.com/cqubioyj/MoviePilot-Plugins,https://github.com/Hqyel/MoviePilot-Plugins-Third"
# 要移除的插件市场
URL_TO_REMOVE="https://github.com/DDS-Derek/MoviePilot-Plugins/"
# 检查 PLUGIN_MARKET 是否为空
if [ -z "${PLUGIN_MARKET}" ]; then
  INFO "PLUGIN_MARKET 变量未设置，使用默认值。"
  PLUGIN_MARKET="${DEFAULT_MARKET}"
else
  INFO "PLUGIN_MARKET 变量已设置，进行检查..."
  # 检查是否包含需要移除的URL
  case "${PLUGIN_MARKET}" in
    *"${URL_TO_REMOVE}"*)
      INFO "发现需要移除的 URL，正在处理..."
      PLUGIN_MARKET="${PLUGIN_MARKET//${URL_TO_REMOVE},/}"
      PLUGIN_MARKET="${PLUGIN_MARKET//${URL_TO_REMOVE}/}"
      ;;
    *)
      INFO "无需修改，使用现有的 PLUGIN_MARKET。"
      ;;
  esac
fi
# 导出最终的变量，以便在后续的命令中使用
export PLUGIN_MARKET
